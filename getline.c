 ...
 * @info: A parameter struct containing context information.
 * @buf: The buffer where input or commands are stored.
 * @len: Variable storing the length of the buffer.
 *
 ...
 * @info: A pointer to a parameter struct
 * that may contain additional context information.
 *
 * Return: The number of bytes read.
 */
 ...
 *
 * Return: A pointer to the read line, or NULL on failure or end of input.
 */
...
/**
 * sigintHandler - command the command ctrl-C.
 * @sig_num: number.
 *
 * Return: void
 */
